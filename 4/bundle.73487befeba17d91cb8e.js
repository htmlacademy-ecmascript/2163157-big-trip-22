...
/* harmony export */   humanizeTaskDueDate: () => (/* binding */ humanizeTaskDueDate),
/* harmony export */   isTaskExpired: () => (/* binding */ isTaskExpired),
/* harmony export */   isTaskRepeating: () => (/* binding */ isTaskRepeating)
/* harmony export */ });
...
function humanizeTaskDueDate(dueDate) {
  return dueDate ? dayjs__WEBPACK_IMPORTED_MODULE_0___default()(dueDate).format(DATE_FORMAT) : '';
}
function isTaskExpired(dueDate) {
  return dueDate && dayjs__WEBPACK_IMPORTED_MODULE_0___default()().isAfter(dueDate, 'D');
}
...
/* harmony import */ var _model_points_model_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./model/points-model.js */ "./src/model/points-model.js");
